...
pak(c(
  ...
  "dplyr", "stringr", "purrr", "reactable","edgeR", 
...
res_all <- readr::read_rds("https://github.com/clstacy/GenomicAnalysis/raw/main/Data/DE_genes/edgeR/yeast_res_all_edgeR.Rds"
```
...
```{r graphing-Paralogs}
plotParalogs(
  kegg_results, res, #pathway_code = "sce00020", 
