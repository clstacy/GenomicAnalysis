...
Question 1: How many genes have a positive logFC and how many have a negative logFC in the in the [(MSN24dd_EtOH - MSN24_MOCK) - (WT_EtOH - WT_MOCK)] comparison (same as we did for EdgeR)? Be sure to clarify the cutoffs used for determining significance.
