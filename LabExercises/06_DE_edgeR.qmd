...
pak("statmod", # required dependency, need to load manually on some macOS versions.
...
pak("edgeR", "AnnotationDbi", "org.Sc.sgd.db")
```
...
## counts2 <- salmon_gene_counts_merged_nonsubsamp
